            ...
            if (biome.getCategory() == Biome.Category.NETHER) {
                ...
                if (Config.STALAGMITE_GENERATION.get()) {
                    biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.SIMPLE_BLOCK.withConfiguration(
                            ...
                            .withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Config.STALAGMITE_PER_CHUNK.get(), 5, 15, 90)))  //per chunk, height from layer 0, height from top layer, max spawn height
                    );
                }
