    ...
    public static void setupSpecificBiomeGen(){
        ...
        for(Biome biome : ForgeRegistries.BIOMES) {
            ...
            if (biome.getCategory() == Biome.Category.JUNGLE) {
                biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.VINES.func_225566_b_(
                        new NoFeatureConfig()
                ));
            }
            ...
            if (biome.getCategory() == Biome.Category.DESERT) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        ...
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(400, 5, 5, 90)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.SAND.getDefaultState(), (int)(Math.random() * 10 + 3)))
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(30, 20, 5, 70)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
            }
            ...
            if (biome.getCategory() == Biome.Category.TAIGA || biome.getCategory() == Biome.Category.ICY) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.SIMPLE_BLOCK.func_225566_b_(
                        ...
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(900, 5, 5, 100)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        ...
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(40, 15, 5, 80)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
            }
            ...
            if (biome.getCategory() == Biome.Category.ICY) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        ...
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(30, 15, 5, 80)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.BLUE_ICE.getDefaultState(), (int)(Math.random() * 10 + 2)))
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(70, 10, 5, 80)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
            }
            ...
            if (biome.getCategory() == Biome.Category.MESA) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        ...
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(50, 5, 5, 90)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                ...
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        ...
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(20, 5, 5, 90)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
            }
            ...
            if (biome.getCategory() == Biome.Category.SWAMP) {
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        ...
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(100, 5, 5, 90)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
            }
            ...
            if (biome.getCategory() == Biome.Category.RIVER) {
                ...
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(
                        new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.SAND.getDefaultState(), (int)(Math.random() * 10 + 3)))
                        .func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(30, 5, 5, 90)))  //per chunk, height from layer 0, height from top layer, max spawn height
                );
            }
