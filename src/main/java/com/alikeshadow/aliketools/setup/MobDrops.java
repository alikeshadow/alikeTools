...
public class MobDrops {
    ...
    public void onMobDrops(LivingDropsEvent event) {
        ...
        if (event.getEntity() instanceof SquidEntity && Config.CALAMARI_DROP.get()) {
            ...
            ItemEntity drop = new ItemEntity(event.getEntity().world, event.getEntity().func_226277_ct_(), event.getEntity().func_226278_cu_(), event.getEntity().func_226281_cx_(), stack);
