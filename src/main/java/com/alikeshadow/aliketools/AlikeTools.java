...
public class AlikeTools {
    ...
    private void setup(final FMLCommonSetupEvent event) {
        ...
        RenderTypeLookup.setRenderLayer(ModBlocks.GLASSSLAB, RenderType.func_228641_d_());
        RenderTypeLookup.setRenderLayer(ModBlocks.GLASSSTAIRS, RenderType.func_228641_d_());
    }
